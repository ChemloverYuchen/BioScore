...
# # output_type: scoring/ranking
# python ../inference.py \
#     --test_set ./data/BioScore_data/PPI_example_6A.pkl \
#     --task PPI \
#     --output_type scoring/ranking \
#     --ckpt ../datasets/PLI+PPI/PPI_finetune/bioscore/version_0/checkpoint/final.ckpt \
#     --save_path ./results/PPI_example_scoring_ranking_results.jsonl \
#     --batch_size 32 \
#     --num_workers 4 \
#     --gpu 0
...
python ../inference.py \
    ...
    --output_type docking/screening \
    --ckpt ../datasets/PLI+PPI/PPI_finetune/bioscore/version_0/checkpoint/final.ckpt \
    --save_path ./results/PPI_example_docking_screening_results.jsonl \
    --batch_size 32 \
    --num_workers 4 \
    --gpu 0
