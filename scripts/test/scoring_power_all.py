...
def main(args):
    ...
    for line in lines[args.topk_start:args.topk_end]:
        ...
        save_dir = os.path.join(PROJ_DIR, args.results_dir, f'scoring_results_{args.test_name}')
...
#                 print(f"inference_time: {inference_time:.4f}s/{num} samples，average：{inference_time/num:.4f}s/sample ")
