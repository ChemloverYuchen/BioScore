...
def parse():
    ...
    parser.add_argument('--outname', type=str, default='PDBbind_NL',
...
def process_line(line, pdb_dir, interface_dist_th):
    ...
    # construct pockets
    interface1, _, _, _, _, _ = cplx.get_interacting_residues(dist_th=interface_dist_th)
    interface2 = []
    for c in lig_chains:
...
def main(args):
    ...
    # split by RNA/DNA (according to na29.csv)
